...
> **English compatibility edition.** The Japanese [object-oriented-design.md](../object-oriented-design.md) is the canonical specification. If this translation differs from the Japanese version, the Japanese version takes precedence.
